...
## Сборка
Собирать проект не надо, достаточно клонировать данный репозиторий. Допускается удаление пользовательских файлов после клонирования и очищение файла name-service.txt (его удалять нельзя).
